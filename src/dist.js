...
function add_css$6() {
	var style = element("style");
	style.id = "svelte-1fbrncu-style";
	style.textContent = ".input.svelte-1fbrncu{position:relative}input.svelte-1fbrncu{font-size:var(--font-size-xsmall);font-weight:var(--font-weight-normal);letter-spacing:var(--font-letter-spacing-neg-xsmall);line-height:var(--line-height);position:relative;display:flex;overflow:visible;align-items:center;width:100%;height:30px;margin:1px 0 1px 0;padding:7px 4px 9px 7px;color:var(--black8);border:1px solid transparent;border-radius:var(--border-radius-small);outline:none;background-color:var(--white)}input.svelte-1fbrncu:hover,input.svelte-1fbrncu:placeholder-shown:hover{color:var(--black8);border:1px solid var(--black1);background-image:none}input.svelte-1fbrncu::selection{color:var(--black);background-color:var(--blue3)}input.svelte-1fbrncu::placeholder{color:var(--black3);border:1px solid transparent}input.svelte-1fbrncu:placeholder-shown{border:1px solid transparent;background-image:url(\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAcAAAAABCAYAAABJ5n7WAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAgSURBVHgB7cMBCQAACMTAiR3sX1TQHr+DK2B+I0lSjj29qAEYlIbeBgAAAABJRU5ErkJggg==\");background-repeat:no-repeat;background-position:center bottom -0.99px;background-size:calc(100% - 10px) 1px}input.svelte-1fbrncu:focus:placeholder-shown{border:1px solid var(--blue);outline:1px solid var(--blue);outline-offset:-2px}input.svelte-1fbrncu:disabled:hover{border:1px solid transparent}input.svelte-1fbrncu:active,input.svelte-1fbrncu:focus{padding:7px 4px 9px 7px;color:var(--black);border:1px solid var(--blue);outline:1px solid var(--blue);outline-offset:-2px}input.svelte-1fbrncu:disabled{position:relative;color:var(--black3);background-image:none}input.svelte-1fbrncu:disabled:active{padding:7px 4px 9px 7px;outline:none}.borders.svelte-1fbrncu{border:1px solid var(--black1);background-image:none}.borders.svelte-1fbrncu:disabled{border:1px solid transparent;background-image:none}.borders.svelte-1fbrncu:disabled:placeholder-shown{border:1px solid transparent;background-image:none}.borders.svelte-1fbrncu:disabled:placeholder-shown:active{border:1px solid transparent;outline:none}.borders.svelte-1fbrncu:placeholder-shown{border:1px solid var(--black1);background-image:none}.indent.svelte-1fbrncu{text-indent:24px}.icon.svelte-1fbrncu{position:absolute;top:-1px;left:0;width:var(--size-medium);height:var(--size-medium);z-index:1}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
	append_dev(document.head, style);
}
...
function create_else_block$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(input, "class", "svelte-1fbrncu");
			toggle_class(input, "borders", /*borders*/ ctx[4]);
			add_location(input, file$6, 141, 4, 3348);
			attr_dev(div, "class", div_class_value = "input " + /*className*/ ctx[9] + " svelte-1fbrncu");
			add_location(div, file$6, 140, 2, 3312);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, input);
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*className*/ 512 && div_class_value !== (div_class_value = "input " + /*className*/ ctx[9] + " svelte-1fbrncu")) {
				attr_dev(div, "class", div_class_value);
			}
		},
		i: noop,
...
function create_if_block$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			t = space();
			input = element("input");
			attr_dev(div0, "class", "icon svelte-1fbrncu");
			add_location(div0, file$6, 126, 4, 3052);
			attr_dev(input, "type", "input");
			attr_dev(input, "id", /*id*/ ctx[1]);
			attr_dev(input, "name", /*name*/ ctx[2]);
			input.disabled = /*disabled*/ ctx[5];
			attr_dev(input, "placeholder", /*placeholder*/ ctx[8]);
			attr_dev(input, "class", "indent svelte-1fbrncu");
			toggle_class(input, "borders", /*borders*/ ctx[4]);
			add_location(input, file$6, 129, 4, 3145);
			attr_dev(div1, "class", div1_class_value = "input " + /*className*/ ctx[9] + " svelte-1fbrncu");
			add_location(div1, file$6, 125, 2, 3016);
		},
		m: function mount(target, anchor) {
		...
		p: function update(ctx, dirty) {
			...
			if (!current || dirty & /*className*/ 512 && div1_class_value !== (div1_class_value = "input " + /*className*/ ctx[9] + " svelte-1fbrncu")) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(125:0) {#if iconName || iconText}",
		ctx
	});
...
class Input extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-1fbrncu-style")) add_css$6();
...
/* src/components/Number/index.svelte generated by Svelte v3.19.1 */
const file$i = "src/components/Number/index.svelte";

function add_css$h() {
	var style = element("style");
	style.id = "svelte-1fbrncu-style";
	style.textContent = ".input.svelte-1fbrncu{position:relative}input.svelte-1fbrncu{font-size:var(--font-size-xsmall);font-weight:var(--font-weight-normal);letter-spacing:var(--font-letter-spacing-neg-xsmall);line-height:var(--line-height);position:relative;display:flex;overflow:visible;align-items:center;width:100%;height:30px;margin:1px 0 1px 0;padding:7px 4px 9px 7px;color:var(--black8);border:1px solid transparent;border-radius:var(--border-radius-small);outline:none;background-color:var(--white)}input.svelte-1fbrncu:hover,input.svelte-1fbrncu:placeholder-shown:hover{color:var(--black8);border:1px solid var(--black1);background-image:none}input.svelte-1fbrncu::selection{color:var(--black);background-color:var(--blue3)}input.svelte-1fbrncu::placeholder{color:var(--black3);border:1px solid transparent}input.svelte-1fbrncu:placeholder-shown{border:1px solid transparent;background-image:url(\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAcAAAAABCAYAAABJ5n7WAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAgSURBVHgB7cMBCQAACMTAiR3sX1TQHr+DK2B+I0lSjj29qAEYlIbeBgAAAABJRU5ErkJggg==\");background-repeat:no-repeat;background-position:center bottom -0.99px;background-size:calc(100% - 10px) 1px}input.svelte-1fbrncu:focus:placeholder-shown{border:1px solid var(--blue);outline:1px solid var(--blue);outline-offset:-2px}input.svelte-1fbrncu:disabled:hover{border:1px solid transparent}input.svelte-1fbrncu:active,input.svelte-1fbrncu:focus{padding:7px 4px 9px 7px;color:var(--black);border:1px solid var(--blue);outline:1px solid var(--blue);outline-offset:-2px}input.svelte-1fbrncu:disabled{position:relative;color:var(--black3);background-image:none}input.svelte-1fbrncu:disabled:active{padding:7px 4px 9px 7px;outline:none}.borders.svelte-1fbrncu{border:1px solid var(--black1);background-image:none}.borders.svelte-1fbrncu:disabled{border:1px solid transparent;background-image:none}.borders.svelte-1fbrncu:disabled:placeholder-shown{border:1px solid transparent;background-image:none}.borders.svelte-1fbrncu:disabled:placeholder-shown:active{border:1px solid transparent;outline:none}.borders.svelte-1fbrncu:placeholder-shown{border:1px solid var(--black1);background-image:none}.indent.svelte-1fbrncu{text-indent:24px}.icon.svelte-1fbrncu{position:absolute;top:-1px;left:0;width:var(--size-medium);height:var(--size-medium);z-index:1}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
	append_dev(document.head, style);
}
...
function create_else_block$6(ctx) {
	...
	function input_input_handler_1() {
		input_updating = true;
		/*input_input_handler_1*/ ctx[11].call(input);
	}
	...
	const block = {
		c: function create() {
			...
			attr_dev(input, "class", "svelte-1fbrncu");
			toggle_class(input, "borders", /*borders*/ ctx[4]);
			add_location(input, file$i, 141, 4, 3349);
			attr_dev(div, "class", div_class_value = "input " + /*className*/ ctx[9] + " svelte-1fbrncu");
			add_location(div, file$i, 140, 2, 3313);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, input);
...
function create_if_block$6(ctx) {
	...
	const block = {
		c: function create() {
			...
			input = element("input");
			attr_dev(div0, "class", "icon svelte-1fbrncu");
			add_location(div0, file$i, 126, 4, 3052);
			attr_dev(input, "type", "number");
			attr_dev(input, "id", /*id*/ ctx[1]);
			attr_dev(input, "name", /*name*/ ctx[2]);
			input.disabled = /*disabled*/ ctx[5];
			...
			attr_dev(input, "class", "indent svelte-1fbrncu");
			toggle_class(input, "borders", /*borders*/ ctx[4]);
			add_location(input, file$i, 129, 4, 3145);
			attr_dev(div1, "class", div1_class_value = "input " + /*className*/ ctx[9] + " svelte-1fbrncu");
			add_location(div1, file$i, 125, 2, 3016);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div1, anchor);
			append_dev(div1, div0);
...
class Number extends SvelteComponentDev {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-1fbrncu-style")) add_css$h();
...
var instance$j = "<svg fill=\"none\" height=\"32\" viewBox=\"0 0 32 32\" width=\"32\" xmlns=\"http://www.w3.org/2000/svg\"><path clip-rule=\"evenodd\" d=\"m16 7 9 9-9 9-9-9zm-7.58579 9 7.58579 7.5858 7.5858-7.5858-7.5858-7.58579z\" fill=\"#000\" fill-rule=\"evenodd\"/></svg>";
...
exports.IconInstance = instance$j;
exports.IconKey = key;
