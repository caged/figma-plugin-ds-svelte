...
<div class="wrapper">
  ...
  <section>
    ...
    <div class="mb-xsmall">
      ...
      <div class="flex row">
        ...
        <Button variant="secondary" destructive class="mr-xxsmall">
          Label
        </Button>
        <Button variant="secondary" destructive disabled class="mr-xxsmall">
          Label
        </Button>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="flex row">
        ...
        <Button variant="tertiary" destructive disabled class="mr-xxsmall">
          Label
        </Button>
      </div>
    </div>
  ...
  <section>
    ...
    <caption class="mb-xsmall">
      ...
      the Icon component and can accept its props.
    </caption>
  ...
  <section>
    ...
    <Input
      iconText="W"
      value="This is an example with a value and a text icon, for example a
      width input" />
  </section>
    ...
    <div class="flex row">
      <div class="p-xsmall mr-xxsmall" style="border: 1px solid var(--black1)">
        <div class="mb-xxsmall">
          ...
          <Type size="small">
            UI12 &mdash; size: small, weight: normal, inverse: false
          </Type>
          <Type size="large">
            UI13 &mdash; size: large, weight: normal, inverse: false
          </Type>
          <Type size="xlarge">
            UI14 &mdash; size: xlarge, weight: normal, inverse: false
          </Type>
        </div>

        <div class="mb-xxsmall">
          <Type weight="medium">
            UI1 &mdash; size: xsmall, weight: medium, inverse: false
          </Type>
          <Type size="small" weight="medium">
            UI2 &mdash; size: small, weight: medium, inverse: false
          </Type>
          <Type size="large" weight="medium">
            UI3 &mdash; size: large, weight: medium, inverse: false
          </Type>
          <Type size="xlarge" weight="medium">
            UI4 &mdash; size: xlarge, weight: medium, inverse: false
          </Type>
        </div>

        <Type weight="bold">
          UI1 &mdash; size: xsmall, weight: bold, inverse: false
        </Type>
        <Type size="small" weight="bold">
          UI2 &mdash; size: small, weight: bold, inverse: false
        </Type>
        <Type size="large" weight="bold">
          UI3 &mdash; size: large, weight: bold, inverse: false
        </Type>
        <Type size="xlarge" weight="bold">
          UI4 &mdash; size: xlarge, weight: bold, inverse: false
        </Type>
      </div>
      ...
      <div class="p-xsmall" style="background-color: var(--black)">
        <div class="mb-xxsmall">
          <Type inverse>
            UI1 &mdash; size: xsmall, weight: normal, inverse: true
          </Type>
          <Type size="small" inverse>
            UI2 &mdash; size: small, weight: normal, inverse: true
          </Type>
          <Type size="large" inverse>
            UI3 &mdash; size: large, weight: normal, inverse: true
          </Type>
          <Type size="xlarge" inverse>
            UI4 &mdash; size: xlarge, weight: normal, inverse: true
          </Type>
        </div>

        <div class="mb-xxsmall">
          <Type weight="medium" inverse>
            UI1 &mdash; size: xsmall, weight: medium, inverse: true
          </Type>
          <Type size="small" weight="medium" inverse>
            UI2 &mdash; size: small, weight: medium, inverse: true
          </Type>
          <Type size="large" weight="medium" inverse>
            UI3 &mdash; size: large, weight: medium, inverse: true
          </Type>
          <Type size="xlarge" weight="medium" inverse>
            UI4 &mdash; size: xlarge, weight: medium, inverse: true
          </Type>
        </div>

        <Type weight="bold" inverse>
          UI1 &mdash; size: xsmall, weight: bold, inverse: true
        </Type>
        <Type size="small" weight="bold" inverse>
          UI2 &mdash; size: small, weight: bold, inverse: true
        </Type>
        <Type size="large" weight="bold" inverse>
          UI3 &mdash; size: large, weight: bold, inverse: true
        </Type>
        <Type size="xlarge" weight="bold" inverse>
          UI4 &mdash; size: xlarge, weight: bold, inverse: true
        </Type>
      </div>
    </div>
  </section>
